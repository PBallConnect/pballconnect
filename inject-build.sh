#!/bin/bash
# Manual utility — the pre-commit hook runs this automatically before every commit.
# Run manually to update the badge in your working copy without committing.
